local get_name_from_table = SMODS.load_file("library/_common/get_name_from_table.lua")()
local get_desc_from_table = SMODS.load_file("library/_common/get_desc_from_table.lua")()
local check_for_override = SMODS.load_file("library/_common/check_for_override.lua")()

local exports = SMODS.load_file("library/g/funcs/create_output/process_edition/_exports.lua")()
